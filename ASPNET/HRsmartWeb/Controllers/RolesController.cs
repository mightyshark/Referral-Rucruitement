...
namespace SkiWorld.Web.Controllers
{
    /// <summary>
    ...
    public class RolesController : Controller
    {
       // private Context ctx = new Context();
        private HRsmartContext _context;
        private ApplicationUserManager _userManager;
        private ApplicationSignInManager _signInManager;

        public HRsmartContext ApplicationDbContext
        {
            get
            {
                return _context ?? HttpContext.GetOwinContext().Get<HRsmartContext>();
            }
        ...
        public ActionResult Create(FormCollection collection)
        {
            try
            {
                ApplicationDbContext.Roles.Add(new HRsmartDomain.Role()
                {
